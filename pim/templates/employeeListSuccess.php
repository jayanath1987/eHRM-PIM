 ...
 function showPage(page){  
     ...
     //pager.showPage(10);
        ...
        childdiv="";
            ...
            data: { datapage: (page1) , searchmode: $('#cmbSearchMode').val() , searchvalue: $('#txtSearchValue').val(), sort:sort , active : '1'},
            dataType: "json",
...
//         }
        ...
        childdiv="";
            ...
            async:false,
            url: "<?php echo url_for('pim/Jpagination') ?>",
            data: { datapage: (this.currentPage-1) , searchmode: $('#cmbSearchMode').val() , searchvalue: $('#txtSearchValue').val(), sort:sort, active : '1'},
            dataType: "json",
            success: function(data){
                    var row = 0; 
                    $.each(data, function(key, value) {

...
<div class="formpage4col" >
    ...
    <div class="outerbox">
        ...
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <br class="clear"/>
            <div class="leftCol">
                <label for="txtLocationCode"><?php echo __("Subject Wise") ?> 
                </label>
                </div>  
 <div class="centerCol" style="width:100px; margin-top: 10px;">

                    <input type="radio" name="optSubject" style="margin-top: 0px;" class="formCheckbox" value="0" <?php
                            if ($EmpEducationHead->eduh_flg == "0") {
                                echo "checked";
                            }
                    ?> />&nbsp;<?php echo __("Yes") ?>
                </div>
                <div class="centerCol" style="width:100px; margin-top: 10px;">
                    <input type="radio" name="optSubject" style="margin-top: 0px;" class="formCheckbox" value="1" <?php
                           if ($EmpEducationHead->eduh_flg == "1") {
                               echo "checked";
                           }
                    ?> />&nbsp;<?php echo __("No") ?>
                </div>
...
?>
            ...
            <div id="divdescription">
               <div class="leftCol">
                <label for="txtLocationCode"><?php echo __("Description") ?> 
                </label>
            </div>
                <div >
                    <textarea style="width: 550px;" id="textDesc" rows="10  " name="textDesc" ><?php echo $EmpEducationHead->eduh_descreption; ?></textarea>
            </div>
            <br class="clear"/>         
            </div>
...
//subjects or description
        $("input[name='optSubject']").change(function(){
            if ($(this).val()==0) {
                    $('#divsubject').show();
                $('#divdescription').hide();
                $('#Addtogridbutton').show();
            }
            else{
                $('#divdescription').show();
                $('#divsubject').hide();
       ...
       <?php if ($EmpEducationHead->eduh_flg == "1") { ?>
                $('#divdescription').show();
                $('#divsubject').hide();
                $('#Addtogridbutton').hide();
       <?php }else if ($EmpEducationHead->eduh_flg == "0"){ ?>
                    $('#divsubject').show();
                $('#divdescription').hide();
                $('#Addtogridbutton').show();
       <?php } ?>    
...
textDesc: {noSpecialCharsOnly: true, maxlength:1000 },
...
textDesc:{maxlength:"<?php echo __("Maximum 1000 Characters") ?>",noSpecialCharsOnly:"<?php echo __("Special Characters are not allowed") ?>"},
